...
('River drawing', 1500,'I want to sell it asap', '001.jpeg',1, 'PUBLISHED'),
('Birds in the wild', 93458, '', '002.jpeg',1, 'DRAFT'),
('Nature', 750,'not for sale now', '003.jpeg',1, 'PUBLISHED'),
('Temple', 500,'Temple', '004.jpeg',1, 'DRAFT'),
('Park', 900,'to save here', '005.jpeg',1, 'PUBLISHED'),
('Little Bird', 290,'Want to sell this photo', '006.jpeg',1, 'PUBLISHED'),
('Autumn', 270,'Autumn park', '007.jpeg',2, 'DRAFT'),
('Mountains', 1000,'Heaven.', '008.jpeg',2, 'PUBLISHED'),
('Butterflies', 1000,'Blue background butterflies', '009.jpeg',2, 'DRAFT'),
('Sad cat', 200,'Sad cat in the rain', '010.jpg',2, 'PUBLISHED');
